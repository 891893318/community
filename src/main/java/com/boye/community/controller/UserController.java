...
import com.boye.community.annotation.LoginRequired;
import com.boye.community.entity.User;
import com.boye.community.service.FollowService;
...
public class UserController implements CommunityConstant {
    ...
    public String getSettingPage(Model model) {
        // 上传文件名称
        String fileName = CommunityUtil.generalUUIO();
        // 设置响应信息
    ...
    public String uploadHeader(MultipartFile headerImage, Model model) {
        ...
        // 生成随机文件名
        fileName = CommunityUtil.generalUUIO() + suffix;
        // 确定文件存放的路径
